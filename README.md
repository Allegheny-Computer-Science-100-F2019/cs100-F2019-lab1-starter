...
- Repository has at least 5 commit(s) beyond the current baseline
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-lab1-starter/
```
